...
template <class T>
inline T rle::Config::get(const std::string &section, const std::string &key) const
{
...
template <class T>
inline void rle::Config::set(const std::string &section, const std::string &key, T &&val)
{
...
template <class T>
inline T rle::Config::getOrDefault(const std::string &section, const std::string &key, T &&dval)
{
